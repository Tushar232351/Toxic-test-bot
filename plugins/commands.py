...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/LazyDeveloper')
             ...
             InlineKeyboardButton('🙆🏻 Bollywood 🦾', url='https://t.me/+C89hPmtLI08zMjk1'),
            InlineKeyboardButton('♥️ Tollywood ♥️', url='https://t.me/+C89hPmtLI08zMjk1')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/+C89hPmtLI08zMjk1')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
